    ...
    <div id="about" className="about">
      ...
      <div className="about-sections">
        <div className="about-left">
            <img src={profile_img} alt="about_profile_img" />
        </div>
        <div className="about-right">
            <div className="about-para">
                <p>I’m a full-stack web developer passionate about building intuitive, user-friendly products that look great and solve real problems.</p>
